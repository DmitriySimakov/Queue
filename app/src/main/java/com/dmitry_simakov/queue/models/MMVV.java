...
public class MMVV extends Model_V {
    ...
    public MMVV() {
        ...
        description = "Очередь M/M/v/K представляет собой систему, в которой интенсивность " +
                ...
                "потери, т.е. K заявок обслуживаются без ожидания, а остальные теряются.\n" +
                "Практическим применением модели M/M/v/K является расчет приборов разговорного " +
                "тракта систем коммутации каналов.";
