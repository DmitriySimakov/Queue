...
public class MM1 extends Model {
    ...
    public MM1() {
        name = "M/M/1";
        description = "Очередь M/M/1 представляет собой очередь, имеющую один канал, где " +
                "интенсивность поступления вызовов определяется расперделением Пуассона, а время " +
                "обслуживания имеет экспоненциальное распределение. Модель является наиболее " +
                "элементарной из моделей очередей и является частным случаем модели M/M/v.\n" +
                ...
                "общий канал сигнализации в сети каналов, канал связи между ЭВМ в сети коммутации " +
                "сообщений.";
